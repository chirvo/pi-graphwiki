...
Reads `graphify-out/graph.json` and generates a browsable wiki with concept pages, community overviews, structural comparisons, and a glossary index. All wiki content can be indexed into mempalace for semantic search.
...
| `graphwiki_status` | Show generation status and indexing instructions |
